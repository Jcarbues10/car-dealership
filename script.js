class CarShowcase {
    ...
    setupEventListeners() {
        ...
        // Mouse wheel navigation (disable on mobile for better scrolling)
        if (!this.isMobile) {
    ...
    handleResize() {
        window.addEventListener('resize', () => {
            ...
            // Refresh features based on screen size
            ...
            } else if (!this.isMobile && this.particles.length === 0) {
                // Re-create particles when switching back to desktop
                this.createParticles();
            }
        });
    }
